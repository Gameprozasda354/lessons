...
namespace EduSys.Repository.Migrations
{
    ...
    [Migration("20230504115655_initial")]
            ...
            modelBuilder.Entity("EduSys.Core.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            CreatedDate = new DateTime(2023, 5, 4, 15, 56, 54, 994, DateTimeKind.Local).AddTicks(4022),
                            Name = "Computer",
                            Price = 800m,
                            Stock = 35m
                        },
                        new
                        {
                            Id = 2,
                            CategoryId = 2,
                            CreatedDate = new DateTime(2023, 5, 4, 15, 56, 54, 994, DateTimeKind.Local).AddTicks(4035),
                            Name = "T-Shirt",
                            Price = 50m,
                            Stock = 400m
                        },
                        new
                        {
                            Id = 3,
                            CategoryId = 3,
                            CreatedDate = new DateTime(2023, 5, 4, 15, 56, 54, 994, DateTimeKind.Local).AddTicks(4036),
                            Name = "Cat food",
                            Price = 25m,
                            Stock = 1000m
                        });
