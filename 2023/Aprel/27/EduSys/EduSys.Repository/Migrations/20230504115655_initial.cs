    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, new DateTime(2023, 5, 4, 15, 56, 54, 994, DateTimeKind.Local).AddTicks(4022), "Computer", 800m, 35m, null });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "CreatedDate", "Name", "Price", "Stock", "UpdatedDate" },
                values: new object[] { 2, 2, new DateTime(2023, 5, 4, 15, 56, 54, 994, DateTimeKind.Local).AddTicks(4035), "T-Shirt", 50m, 400m, null });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "CreatedDate", "Name", "Price", "Stock", "UpdatedDate" },
                values: new object[] { 3, 3, new DateTime(2023, 5, 4, 15, 56, 54, 994, DateTimeKind.Local).AddTicks(4036), "Cat food", 25m, 1000m, null });
