...
namespace EduSys.Repository.Migrations
{
    ...
    [Migration("20230701124255_changed-user-relation")]
    partial class changeduserrelation
    {
            ...
            modelBuilder.Entity("EduSys.Core.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            CreatedDate = new DateTime(2023, 7, 1, 16, 42, 55, 6, DateTimeKind.Local).AddTicks(3191),
                            Name = "Computer",
                            Price = 800m,
                            Stock = 35
                        },
                        new
                        {
                            Id = 2,
                            CategoryId = 2,
                            CreatedDate = new DateTime(2023, 7, 1, 16, 42, 55, 6, DateTimeKind.Local).AddTicks(3200),
                            Name = "T-Shirt",
                            Price = 50m,
                            Stock = 400
                        },
                        new
                        {
                            Id = 3,
                            CategoryId = 3,
                            CreatedDate = new DateTime(2023, 7, 1, 16, 42, 55, 6, DateTimeKind.Local).AddTicks(3201),
                            Name = "Cat food",
                            Price = 25m,
                            Stock = 1000
                        });
