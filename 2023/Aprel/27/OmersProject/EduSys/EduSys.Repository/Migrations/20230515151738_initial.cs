    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, new DateTime(2023, 5, 15, 19, 17, 38, 41, DateTimeKind.Local).AddTicks(1017), "Computer", 800m, 35, null });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "CreatedDate", "Name", "Price", "Stock", "UpdatedDate" },
                values: new object[] { 2, 2, new DateTime(2023, 5, 15, 19, 17, 38, 41, DateTimeKind.Local).AddTicks(1027), "T-Shirt", 50m, 400, null });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "CreatedDate", "Name", "Price", "Stock", "UpdatedDate" },
                values: new object[] { 3, 3, new DateTime(2023, 5, 15, 19, 17, 38, 41, DateTimeKind.Local).AddTicks(1028), "Cat food", 25m, 1000, null });
